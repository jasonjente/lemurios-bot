...
import bot.exceptions.ApplicationInitializationException;
...
public class PropertiesUtil {
    ...
    public void init(){
        ...
        {
            String errorMessage = "Error importing properties file {}, make sure that the file exists and that it has the proper access rights and encoding.";
