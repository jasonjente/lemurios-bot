...
public class MusicPlayer {
    ...
    private void createReturnMessageAndPlayTrack(final SlashCommandInteractionEvent event, final AudioTrack track,
        ...
        var inputStream = getYoutubeThumbnail(track.getInfo().identifier);
    ...
    public String disconnectFromVoiceChannel(final AudioManager audioManager) {
        if (audioManager.getConnectedChannel() != null) {
            ...
            throw new InvalidBotStateException("Attempted to disconnect from a channel that doesn't exist?");
        }
    }
    private InputStream getYoutubeThumbnail(final String id) {
        try {
            ...
            log.error("error downloading thumbnail: {}", id, e);
        }
        return null;
    }
